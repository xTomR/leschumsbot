 ...
 const getExpPerGame = async () => {
  ...
  const findLp1 = async () => {
   ...
   const lp1 = await matchSchema.find({
    $and: [{ lpmultiplier: 1 }, { expCounted: false }],
   });
  ...
  const findLp2 = async () => {
   ...
   const lp2 = await matchSchema.find({
    $and: [{ lpmultiplier: 2 }, { expCounted: false }],
   });
  ...
  const findLp3 = async () => {
   ...
   const lp3 = await matchSchema.find({
    $and: [{ lpmultiplier: 3 }, { expCounted: false }],
   });
  ...
  const findLp4 = async () => {
   ...
   const lp4 = await matchSchema.find({
    $and: [{ lpmultiplier: 4 }, { expCounted: false }],
   });
  ...
  const findLp5 = async () => {
   ...
   const lp5 = await matchSchema.find({
    $and: [{ lpmultiplier: 5 }, { expCounted: false }],
   });
