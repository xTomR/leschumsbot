...
const rankedIcon = {
    'iron': galeforce.lol.ddragon.profileIcon.art()
    .version('11.21.1')
    .assetId(5123)
    .URL(),
    'bronze': galeforce.lol.ddragon.profileIcon.art()
    .version('11.21.1')
    .assetId(5124)
    .URL(),
    'silver': galeforce.lol.ddragon.profileIcon.art()
    .version('11.21.1')
    .assetId(5125)
    .URL(),
    'gold': galeforce.lol.ddragon.profileIcon.art()
    .version('11.21.1')
    .assetId(5126)
    .URL(),
    'platinum': galeforce.lol.ddragon.profileIcon.art()
    .version('11.21.1')
    .assetId(5127)
    .URL(),
    'diamond': galeforce.lol.ddragon.profileIcon.art()
    .version('11.21.1')
    .assetId(5128)
    .URL(),
    'master': galeforce.lol.ddragon.profileIcon.art()
    .version('11.21.1')
    .assetId(5128)
    .URL(),
    'grandmaster': galeforce.lol.ddragon.profileIcon.art()
    .version('11.21.1')
    .assetId(5129)
    .URL(),
    'challenger': galeforce.lol.ddragon.profileIcon.art()
    .version('11.21.1')
    .assetId(5130)
    .URL(),
    }
