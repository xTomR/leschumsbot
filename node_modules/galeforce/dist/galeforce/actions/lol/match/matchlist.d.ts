...
declare type GetMatchlistQuery = {
    start?: number;
    count?: number;
};
declare const BaseAction: {
    ...
    new (...args: any[]): {
        query<K_1 extends import("../../mixins/query").QueryChainable<GetMatchlistQuery> & import("../../mixins/executable").Executable>(this: K_1, query: GetMatchlistQuery): Omit<K_1, "query">;
    };
} & {
    new (...args: any[]): {
